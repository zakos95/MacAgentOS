...
def activate() -> str:
    ...
    return run_as('tell app "Google Chrome" to activate')
        
@mcp.tool()
def quit() -> str:
    """Ferme Google Chrome"""
    return run_as('tell app "Google Chrome" to quit')

if __name__ == "__main__":
    print("🚀 MCP for Google Chrome starting...")
    mcp.run()
